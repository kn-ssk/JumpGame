...
<body>
    <div class="slide-container">
        <div class="slide-wrapper">
            <img class="slide" src="images/a.jpg" alt="ENFJ">
            <img class="slide" src="images/b.jpg" alt="ENFP">
            <img class="slide" src="images/c.jpg" alt="ENTJ">
            <img class="slide" src="images/a.jpg" alt="ENFJ">
            <img class="slide" src="images/c.jpg" alt="ENTJ">
            <img class="slide" src="images/b.jpg" alt="ENFP">
            <img class="slide" src="images/c.jpg" alt="ENTJ">
            ...
            <img class="slide" src="images/b.jpg" alt="ENFP">
            <img class="slide" src="images/c.jpg" alt="ENTJ">
            <img class="slide clear-slide" src="images/clear.png" alt="Clear" style="display: none;">
        </div>
...
<div class="button-container"></div>
    ...
    <form action="RetryEasyServlet" method="get">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const obstacles = document.querySelectorAll('.obstacle, .obstacle-1, .obstacle-2,.obstacle-3,.obstacle-4,.obstacle-5');
